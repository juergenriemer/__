this.__compareTo=function(){};this.__struc=function(){};this.__remove=function(){};this.__toString=function(){};this.__toJson=function(){};"undefined"==typeof __&&(__={});Object.defineProperty(String.prototype,"__toJson",{value:function(){try{return JSON.parse(this)}catch(a){return null}}});Object.defineProperty(String.prototype,"__isEmpty",{value:function(){return""===this.trim()}});
Object.defineProperty(String.prototype,"__toCamelCase",{value:function(){var a=[];this.split(" ").forEach(function(b){b&&a.push(b.substr(0,1).toUpperCase()+b.substr(1))});return a.join(" ")}});Object.defineProperty(String.prototype,"__unCamelCase",{value:function(){s=this.replace(/([A-Z])([a-z])/g," $1$2");s=s.replace(/([a-z])([A-Z])/g,"$1 $2");return s.trim()}});
...
Object.defineProperty(Array.prototype,"__remove",{value:function(a){var b=this.indexOf(a);-1<b&&(this.splice(b,1),this.__remove(a))}});Object.defineProperty(Array.prototype,"__contains",{value:function(a){return-1<this.indexOf(a)}});Object.defineProperty(Array.prototype,"__empty",{value:function(){return 0==this.length}});
