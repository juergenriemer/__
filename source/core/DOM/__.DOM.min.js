this.__hide=function(){};this.__show=function(){};this.__cbScroll=function(){};
Object.defineProperty(Node.prototype,"__find",{value:function(a,b){var c="BODY"==this.tagName.toUpperCase()?document:this,d="querySelectorAll";if(/^.[a-zA-Z0-9_-]*$/.test(a)){var e=a.substr(0,1);"#"==e?(d="getElementById",a=a.substr(1)):"."==e?(d="getElementsByClassName",a=a.substr(1)):/[a-zA-Z]/.test(e)&&(d="getElementsByTagName")}c=c[d](a);if(c=HTMLCollection.prototype.isPrototypeOf(c)?[].slice.call(c):c)if(b&&__.dn.each(c,b),d=c.length,!isNaN(d)){if(1==d)return c[0];if(0==d)return null}return c}});
