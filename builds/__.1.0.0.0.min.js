...
window.__css=function(a){var b=document.createElement("style");document.getElementsByTagName("head")[0].appendChild(b);b.innerHTML=a};Object.defineProperty(Array.prototype,"__each",{value:function(a){for(var b=this.length,c=0;c<b;c++)a(this[c])}});Object.defineProperty(Node.prototype,"__each",{value:function(a){a(this)}});
...
Object.defineProperty(Node.prototype,"__onScroll",{value:function(a,b){b=b||300;var c=this==document?document.body:this;this.__cbScroll=function(){c.b&&clearInterval(c.b);c.b=setTimeout(function(){var b=c.scrollHeight,e=c.scrollTop,f=c.clientHeight,h=c.scrollWidth,g=c.scrollLeft,k=c.clientWidth;a({x:g,y:e,dxcur:h,dycur:b,dy:f,dx:k,bTop:0==e,bBottom:e+f>=b,bLeft:0==g,bRight:g+k>=h})},b)};this.addEventListener("scroll",this.__cbScroll)}});
...
__.utils.dt={date:function(a){a="object"==typeof a?a:"string"==typeof a?new Date(a.replace(/\D/g,"-")):new Date;var b=a.getDate(),c="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")[a.getDay()],f=a.getMonth(),g="January February March April May June July August September October November December".split(" ")[f],m=g.substring(0,3),e=a.getFullYear(),d=a.getHours?a.getHours():0,k=a.getMinutes?a.getMinutes():0,h=a.getSeconds?a.getSeconds():0,n=10>d?"0"+d:d,p=10>k?"0"+k:k;return{nDay:b,
sDay:c,sDayShort:c.substring(0,3),nMonth:f,sMonth:g,sMonthShort:m,nYear:e,nHour:d,nMinute:k,nSecond:h,sHour:n,sMinute:p,sSecond:10>h?"0"+h:h,sdtdft:[m,b,e].join(" ")+" "+[n,p].join(":"),dt:a}},diff:function(a,b){return Math.ceil((a.getTime()-(b||new Date).getTime())/864E5)}};__.utils.misc={isIE:function(){return"Microsoft Internet Explorer"==navigator.appName?!0:"Netscape"==navigator.appName?-1<navigator.appVersion.indexOf("Edge"):!1}};
if( typeof( __ ) == "undefined" ) {
	__ = {};
}
